              ...
              <div className="flex-1 w-full">
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex space-x-3">
                    <Link href="/dashboard/buyer/tracking" className="bg-[#eef3e8] text-green-800 font-bold px-5 py-2.5 rounded-xl transition-colors text-sm border border-[#d4dec4] hover:bg-[#e1e8d5]">
                      View Detail
                    </Link>
                    <Link href="/dashboard/buyer/tracking" className="bg-[#388e3c] hover:bg-[#2e7d32] text-white font-bold px-5 py-2.5 rounded-xl transition-colors text-sm shadow-md">
                      Track Order
                    </Link>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-3xl p-6 border border-[#eef3e8] shadow-sm flex flex-col sm:flex-row gap-6 items-center sm:items-start relative mb-6">
                ...
                <div className="flex-1 w-full flex flex-col h-full">
                  ...
                  <div className="flex space-x-3 mt-auto">
                    <Link href="/dashboard/buyer/orders/OP-9921" className="bg-[#388e3c] hover:bg-[#2e7d32] text-white font-bold px-6 py-3 rounded-xl transition-colors text-sm shadow-md">
                      Request Refund
                    </Link>
                    <Link href="/dashboard/buyer/orders/OP-9921" className="bg-[#eef3e8] text-green-800 font-bold px-6 py-3 rounded-xl transition-colors text-sm border border-[#d4dec4] hover:bg-[#e1e8d5]">
                      Order Details
                    </Link>
                  </div>
                </div>
