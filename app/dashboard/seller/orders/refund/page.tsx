...
export default function RefundPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="mb-8">
        <Link href="/dashboard/seller/orders" className="inline-flex items-center space-x-2 text-sm font-bold text-gray-500 hover:text-gray-900 mb-4 transition-colors">
          <ArrowLeft size={16} />
