      ...
      <header className="h-20 px-8 flex items-center justify-between bg-[#F3F8F2]">
        ...
        <div className="flex items-center space-x-5">
          ...
          <button
            ...
            className="text-[#1A5632] hover:text-green-800 transition-colors"
          >
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 flex flex-col justify-center relative mt-16 pb-20">
        <div className="absolute -top-12 left-4">
          <button
            ...
            className="flex items-center space-x-2 text-gray-500 hover:text-[#1A5632] transition-colors font-bold text-sm bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-100"
          >
            <ArrowLeft size={16} />
            <span>Back</span>
          </button>
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">
            What do you want to do with this food?
          </h1>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto font-medium">
            Select the path for your surplus produce. Every choice contributes to the EcoEat cycle of sustainability.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 w-full">
          <div
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') setChoice('sell');
            }}
          ...
          <div
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') setChoice('donate');
            }}
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 text-[10px] font-bold text-gray-500 tracking-widest uppercase">
            Step 2 of 4: Distribution Intent
          </p>
        </div>
      </main>
    </div>
