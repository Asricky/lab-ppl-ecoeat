...
<<<<<<< HEAD:components/ActiveTaskCard.tsx
...
=======
        <Link href="/dashboard/kurir/tasks/ORD-1" className="flex-1 bg-[#388e3c] text-white font-bold py-3.5 rounded-xl hover:bg-[#2e7d32] transition-colors shadow-md shadow-green-900/10 text-lg text-center">
>>>>>>> origin/Alya:app/components/ActiveTaskCard.tsx
          View Route
        </Link>
