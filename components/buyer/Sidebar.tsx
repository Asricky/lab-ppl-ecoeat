...
export default function Sidebar({ isOpen, setIsOpen }: { isOpen: boolean, setIsOpen: (val: boolean) => void }) {
  ...
  const links = [
    ...
    { name: 'Explore', icon: ShoppingBag, path: '/dashboard/buyer/explore' },
    { name: 'Orders', icon: ShoppingBag, path: '/dashboard/buyer/orders' },
    { name: 'Saved Items', icon: Heart, path: '/dashboard/buyer/saved' },
    { name: 'Tracking', icon: Truck, path: '/dashboard/buyer/tracking' },
    { name: 'Profile', icon: User, path: '/dashboard/buyer/profile' },
  ];
