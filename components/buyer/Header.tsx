    ...
    <header className="bg-[#f4f7ed] sticky top-0 z-30 px-6 py-4 flex items-center justify-between border-b border-[#e1e8d5]">
      <div className="flex items-center">
        ...
        <div className="hidden md:flex space-x-8 text-sm font-bold text-gray-500">
          <Link href="/dashboard/buyer/explore" className="hover:text-green-800 transition-colors">Marketplace</Link>
          <Link href="/dashboard/buyer/surplus" className="hover:text-green-800 transition-colors">Surplus</Link>
          <Link href="/dashboard/buyer/impact" className="hover:text-green-800 transition-colors">Impact</Link>
          <Link href="/dashboard/buyer/orders" className="hover:text-green-800 transition-colors border-b-2 border-green-700 text-green-800 pb-1">My Orders</Link>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-5">
        ...
        <Link href="/dashboard/buyer/cart" className="relative text-gray-500 hover:text-green-700 transition-colors">
